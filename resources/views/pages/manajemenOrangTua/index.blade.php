...
<div class="page-body">
    ...
    <div class="container-fluid">
        <div class="page-header">
            <div class="row">
                <div class="col-lg-6">
                    <h3>Manajemen Orang Tua
                        <small>Kelola Informasi Pengajar / Orang Tua</small>
                    </h3>
                </div>
                <div class="col-lg-6">
                    <ol class="breadcrumb pull-right">
                        <li class="breadcrumb-item"><a href="#"><i class="fa fa-home"></i></a></li>
                        <li class="breadcrumb-item active">Manajemen Orang Tua</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="header-button">
                            <a href="" class="btn btn-success">Tambah Orang Tua</a>
                        </div>
                    </div>
                    <div class="card-body">
